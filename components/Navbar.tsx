        ...
        >
            <div className='max-w-[1240px] m-auto flex justify-between items-center px-4 text-white '>
                <Link href='/' className='cursor-pointer'>
                    <img className='w-[180px] sm:w-[200px] cursor-pointer' src="/images/bnlogo.webp" />
                </Link>
                <ul style={{ color: `${textColor}` }} className='hidden lg:flex gap-6 items-center'>
                    {/* <li className='p-2'>
                        <Link href='/'>Home</Link>
                    </li> */}
                    ...
                    <li className='flex items-center text-white'>
                        <Link href="/contact">
                            <div className='py-2 px-6 bg-[#004f4f] rounded-full cursor-pointer hover:bg-[#1b7777]'>Contact Us</div>
                        </Link>
                    </li>
                </ul>
                ...
                >
                    <ul>
                        ...
                        <li className='flex justify-center'>
                            <Link href="/contact">
                                <div className='py-2 px-6 bg-[#004f4f] rounded-full cursor-pointer text-2xl sm:text-3xl hover:bg-[#1b7777]'>Contact Us</div>
                            </Link>
                        </li>
                    </ul>
                </div>
