...
const OurServices = () => {
    return (
        <div id='service' className='py-12 flex flex-col justify-center items-center '>
            <h1 className='sm:text-5xl text-3xl mb-12 font-semibold text-[#1f2278]'>Our Services</h1>
            <div className='sm:p-4 flex flex-wrap justify-center'>
                {/* one */}
                <div className="w-full max-w-[380px] sm:w-[400px] px-2 py-4 m-4 rounded-lg border border-gray-200 shadow-md bg-[#b4d4fe] hover:bg-[#f5f6fe] dark:border-gray-700">
                 ...
                 */}
                        ...
                        <h5 className="mb-4 text-3xl text-[#1f2278] text-center font-semibold">Instant Answers 24x7</h5>
                        <h6 className="text-xl text-center mx-2  mb-2">Whether it’s a seemingly silly question or what seems to be a serious concern - at any given time of the day, just ask and get an answer from a pediatrician in 10 minutes! They’re here for you throughout.</h6>
            ...
            <a href="#" className="inline-flex items-center py-2 px-4 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add friend</a>
                 ...
                 */}
                        ...
                        <h5 className="mb-4 text-3xl text-[#1f2278] text-center font-semibold  ">Online Pre-Consultation & Second Opinions</h5>
                        <h6 className="text-xl text-center mx-2   mb-2">No more wondering whether you really need to visit your pediatrician for small concerns and report reviews or figuring out where to get a second opinion. Just get answers from our trusted pediatricians at babynama!</h6>
            ...
            <a href="#" className="inline-flex items-center py-2 px-4 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add friend</a>
                 ...
                 */}
                        ...
                        <h5 className="mb-4 text-3xl text-[#1f2278] text-center font-semibold">Guidance from Trusted Nutritionists</h5>
                        <h6 className="text-xl text-center mx-2   mb-2">Get the right guidance on your child's nutrition needs from experts.</h6>
                        {/* <div className="flex mt-4 space-x-3 lg:mt-6">
            <a href="#" className="inline-flex items-center py-2 px-4 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add friend</a>
        </div> */}
                    </div>
                 ...
                 */}
                        ...
                        <h5 className="mb-4 text-3xl text-[#1f2278] text-center font-semibold">Growth & Development Tracking + Consultations</h5>
                        <h6 className="text-xl text-center mx-2   mb-2">Should my child start speaking by now?” “Should they start walking?” “My sister's son used to walk at this age, should I be worried if my baby is not walking?” babynama app has built-in tools to answer all these questions for you along with tracking your child’s growth and development as per their age!</h6>
                        {/* <div className="flex mt-4 space-x-3 lg:mt-6">
            <a href="#" className="inline-flex items-center py-2 px-4 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add friend</a>
        </div> */}
                    </div>
